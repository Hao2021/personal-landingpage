...
const callToActionData = {
    ...
    subtitle: "Random thoughs and ideas",
    btnText: "My Blog",
}
                    ...
                    <div className="col-lg-4 col-md-4">
                        ...
                        animateOnce={true}>
                            <div className="call-to-btn text-left mt_sm--20 text-md-right">
                                ...
                                <a className="btn-default btn-icon" target="_blank" href="https://sunhao-blog.herokuapp.com">{callToActionData.btnText} <i className="icon"><FiArrowRight /></i></a>
                            </div>
                        </ScrollAnimation>
                    </div>
                </div>
